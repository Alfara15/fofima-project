...
<div class="row no-gutters mt-5" >
    <div class="col-md-2 bg-dark mt-2 pr-3 pt-4" style="position:fixed; z-index:4;overflow-y: scroll; height:calc(100%-10vh); bottom:0px; top:3rem;">
<ul class="nav flex-column ml-3 mb-5" >
  ...
  <li class="nav-item">
    <a class="nav-link text-light  abu-link" href="#"><i class="bi bi-clipboard-check"></i> TRANSAKSI</a><hr class="bg-secondary">
  </li>
