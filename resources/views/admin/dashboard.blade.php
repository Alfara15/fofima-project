...
@section("konten")
  ...
  <div class="card-body">
    ...
    <div class="container">
        <div class="ch"style="width:70%; margin-left: 350px;">
  ...
  <div class="container col-sm-4 col-md-7 col-lg-4 mt-5"style="width: 39%; margin-right:80%;  ">
    <div class="bla"style=" margin-top:-371 px;">
    <div class="card">
