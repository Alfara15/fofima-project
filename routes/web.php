...
Route::post('/admin/bukubesar/transaksi', 'TransaksiController@prosestransaksi');
Route::get('/admin/BukuBesar', 'BukuBesarController@index');
Route::match(['get','post'],'/admin/BukuBesar/cari', 'BukuBesarController@tampilkan');
Route::get('/admin/neracaLajur', 'NeracaLajurController@index');
Route::post('/admin/neracaLajur/cari', 'NeracaLajurController@cari');
...
Route::middleware('role:yayasan')->get('/admin', function() {
    return "Dashboard";
})->name('dashboard');
